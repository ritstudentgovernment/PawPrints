...
urlpatterns = [
    ...
    re_path(r'^settings/notifications/staff/(?P<username>\w+)$',
            views.update_staff_emailing, name='staff_notification'),
    re_path(r'^settings/notifications/(?P<user_id>\d+)$',
            views.update_notifications, name='notification_update'),
    ...
    re_path(r'^manage/manager/remove/(?P<user_id>\d+)$',
            views.remove_staff_member),
