...
(function ($) {
    ...
    this.settings = $.extend(
      {
        ...
        bodyButtons: [
          [
            "Next Section",
            "modern-button margin-bottom margin-top transition cursor",
            function () {},
          ],
        ],
  ...
  Modal.prototype.open = function () {
    ...
    me.element.find(".modal-container").cssanimate(me.settings.inAnimation, {
      duration: me.settings.animationDuration,
    });
  };
  Modal.prototype.close = function () {
    ...
    me.element
      ...
      .cssanimate(
        this.settings.outAnimation,
        { duration: this.settings.animationDuration * 2 },
        function () {
          ...
          _initAnchors: function () {
            ...
            o.$body.on(r.click + "-oncanvas", "a[href]", function (i) {
              ...
              if (
                ...
                f && i.preventDefault(),
                  e.__valueOrFn(e.opts.onClick.close, a, f) && e.close();
              }
            });
          },
