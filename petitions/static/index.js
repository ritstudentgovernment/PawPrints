    ...
    function openPetition(petitionID, auto_open = false, counter = 0){
        ...
        if(!toPetition){
            ...
            modal.find(".modal-container").cssanimate("fadeInUp",{hide:true}, () => {
    ...
    $(document).ready(function(){
        ...
        $(document).on("click","#sign-petition-button", () => {
        ...
        $(document).on("click","#publish-button", () => {
            var petition = getUrl("p");
        ...
        var paginationTimeout = setTimeout(() => {},0);
        $(window).scroll(() => {
            var win = $(window);
