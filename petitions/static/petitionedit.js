  ...
  var a = e(function (e, a) {
    ...
    t = e(function (e, a) {
      function t(e) {
        var a = e.match(o);
        if (null === a) return !1;
        for (var t = r.length - 1; t >= 0; t--) if (r[t].test(e)) return !1;
        var i = a[2];
        return !!i && -1 !== n.tlds.indexOf(i);
      }
      Object.defineProperty(a, "__esModule", { value: !0 });
      var o =
    ...
    o = e(function (e, n) {
      function t(e) {
        ...
        var c = (n[3].match(/(^\d+)(:)(\d+)/) || [])[3];
        return !(c && !a.isPort(c));
      }
      Object.defineProperty(n, "__esModule", { value: !0 });
      var o =
        /^(\d{1,3}\.){3}\d{1,3}(:\d{1,5})?(\/([a-z0-9\-._~:\/\?#\[\]@!$&'\(\)\*\+,;=%]+)?)?$/i;
      n.default = t;
    }),
    r = e(function (e, t) {
      function o(e) {
        ...
        return (
          null !== t &&
          "string" == typeof t[3] &&
          -1 !== n.tlds.indexOf(t[3].toLowerCase()) &&
          !(t[5] && !a.isPort(t[5]))
        );
      }
        ...
        return e.map(function (i, s) {
          ...
          return (
            ...
            a.files &&
              "file:///" === d &&
              l.split(/\/|\\/).length - 1 &&
              (u = { reason: "file", protocol: d, raw: i, encoded: l }),
            !u &&
              a.urls &&
              r.default(l) &&
              (u = {
                ...
                protocol:
                  d ||
                  ("function" == typeof a.defaultProtocol
                    ? a.defaultProtocol(i)
                    : a.defaultProtocol),
                raw: i,
                encoded: l,
    ...
    u = e(function (e, a) {
      function n(e, a) {
        ...
        if (a.exclude)
          for (var i = 0; i < r.length; i++) {
            var c = r[i];
            "object" == typeof c && a.exclude(c) && (r[i] = c.raw);
          }
        if (a.list) {
          for (var u = [], d = 0; d < r.length; d++) {
            var b = r[d];
            "string" != typeof b && u.push(b);
          }
          return u;
        }
        return (
      ...
      function t(e, a) {
        var n = e.protocol + e.encoded,
          t = e.raw;
        return (
          "number" == typeof a.truncate &&
            t.length > a.truncate &&
            (t = t.substring(0, a.truncate) + "..."),
          "object" == typeof a.truncate &&
            t.length > a.truncate[0] + a.truncate[1] &&
            (t =
              t.substr(0, a.truncate[0]) +
              "..." +
              t.substr(t.length - a.truncate[1])),
          void 0 === a.attributes && (a.attributes = []),
          '<a href="' +
            n +
            '" ' +
            a.attributes
    ...
    d = e(function (e, n) {
      ...
      (i.validate = {
        ...
        url: function (e) {
          var a = c.default(e) || "";
          return (e = e.substr(a.length)), (e = encodeURI(e)), r.default(e);
        },
        email: t.default,
      }),
        (n.default = i);
...
function verifyInputs() {
  ...
  $(".verify").each(function () {
    ...
    if (input.hasClass("editable")) {
      ...
      if (
        value.trim() === "" ||
        scoreLikeness(value, "{{ default_title }}") > 0.9 ||
        scoreLikeness(value, "{{ default_body }}") > 0.9
      ) {
        ...
        allPass = false;
        message +=
          "Your petition title may not be longer than 80 characters.\n";
        input.addClass("error");
      }
    } else {
      value = input.val();
...
$(document).ready(function () {
  tinymce.init({
    ...
    toolbar:
      "insert | undo redo | styleselect | bold italic backcolor  | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link removeformat",
  ...
  tinymce.init({
    ...
    init_instance_callback: function (editor) {
      editor.on("Change", function (e) {
        var value = ucfirst(
          e.level.content.trim().replace(/<\/?[^>]+(>|$)/g, "")
        );
        if (value.length > 80) {
          errorModal(
            "Your petition title may not be longer than 80 characters."
